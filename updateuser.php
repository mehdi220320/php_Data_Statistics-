    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
        ...
        if(empty($password)){
            ...
            if($password != $confpassword){
                $error="Please confirme the password";
            }else{
        ...
        if(empty($error)){
            $stmt = $db->prepare("UPDATE user SET nom = :fname, prenom = :lname, email = :email, password = :password, description = :description WHERE id_user = :id");
...
<div class="d-flex flex-column" id="content-wrapper">
    <div id="content">
        ...
        <div class="container-fluid">
            <h4 class="text-dark mb-5" style="font-size: 3em;font-family: 'Bodoni MT Poster Compressed'">Update User: <?php echo $fname ." ". $lname ?></h4>
                            ...
                            <div class="row">
                                <div class="col-lg-15">
                                    <div class="p-5">
                                        ...
                                        <?php endif; ?>
                                        <form class="user" method="post" action="updateuser.php?id=<?php echo $_GET['id'];?>" style="color: black">
                                            <div class="row mb-3">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    <input class="form-control form-control-user" type="text" style="color: black;" value="<?php echo isset($fname) ? $fname : ''; ?>" id="exampleFirstName" placeholder="First Name" name="first_name">
                                                </div>
                                                <div class="col-sm-6">
                                                    <input class="form-control form-control-user" type="text" style="color: black;"  value="<?php echo isset($lname) ? $lname : ''; ?>" id="exampleLastName" placeholder="Last Name" name="last_name">
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <input class="form-control form-control-user" type="email" style="color: black;"  value="<?php echo isset($email) ? $email : ''; ?>" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Email Address" name="email">
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <div class="mb-3 ">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1" style="color: black;"  name="description" rows="3"><?php echo isset($description) ? $description : ''; ?></textarea>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                ...
                                                <div class="col-sm-6">
                                                    <button class="btn btn-primary d-block btn-user w-100" ><a href="UsersTable.php" style="color: white">Go back</a></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
